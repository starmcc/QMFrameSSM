package com.qm.code.util.baidu;
...
import com.qm.code.entity.baidu.BaiDuMeasurement;
...
public class BaiduStatisticsUtil {
	...
	public static Integer getSeparation(String address1, String address2) {
		...
		QmLog.debug(address1 + "纬度--->" + baiDuMeasurement1.getLongitude());
		QmLog.debug(address1 + "经度--->" + baiDuMeasurement1.getLatitude());
		BaiDuMeasurement baiDuMeasurement2 = getLatAndLngByAddress(address2);
		QmLog.debug(address2 + "纬度--->" + baiDuMeasurement2.getLongitude());
		QmLog.debug(address2 + "经度--->" + baiDuMeasurement2.getLatitude());
