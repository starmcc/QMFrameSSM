...
public @Component class InitStartApi {
	...
	private final static Logger LOG = Logger.getLogger(InitStartApi.class);
	...
	public void init() {
		LOG.info("\n" +
				...
				"\n开源:[https://github.com/starmcc/QMFrameSSM]" +
	...
	public void preDestroy() {
		LOG.info("浅梦gitHub:https://github.com/starmcc/QMFrameSSM");
	}
}
