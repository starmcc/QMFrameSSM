...
public class QmExceptionHandler extends QmController{
    ...
    public String IllegalArgumentException(HttpServletResponse response, Exception e) {
    	response.setStatus(200);
    	 return super.sendJSON(QmCode._100);
    }
    
    @ExceptionHandler(InstantiationException.class)
    public String InstantiationException(HttpServletResponse response, Exception e) {
    	response.setStatus(200);
    	 return super.sendJSON(QmCode._100);
    }
    ...
    public String notFoundPage404(HttpServletResponse response, Exception e) {
        response.setStatus(200);
